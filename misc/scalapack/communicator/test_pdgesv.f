      SUBROUTINE TEST_PDGESV(RANK, ICTXT, NBSD)

      INTEGER ICTX
      INTEGER RANK ! inutile
      INTEGER NBSD
*
...
*
      ...
      PRINT *, 'dans test', RANK, NPROW, NPCOL, MYROW, MYCOL
*
...
*
      CALL MATINIT( A, DESCA, B, DESCB, NBSD )
*
...
*
 ...
 9993 FORMAT( / '||A*x - b|| / ( ||x||*||A||*eps*N ) = ', 1P, E16.8 )
      ...
      SUBROUTINE MATINIT( AA, DESCA, B, DESCB, NBSD )
*
