program clusters
 ...
 ! modif sandrine
  ...
  character*20 filename, snumproc
...
!    open(file="debug0.txt", unit = 22)
!    write(22,*) 'coord'
!    write(22,*) size(coordmin, 1), size(coordmax, 1)
!    write(22,*) coordmin
!    write(22,*) coordmax
!
!
!    write(22,*) 'partitioning'
!    write(22,*) size(decoupe, 1)
!    write(22,*) decoupe
!
!    write(22,*) 'points_by_domain'
!    write(22,*) size(ldat, 1)
!    write(22,*) ldat
!
!    write(22,*) 'assignments'
!    write(22,*) size(ddat, 1)
!    write(22,*) size(ddat, 2)
!    do i = 1, size(ddat, 2)
!      write(22,*) i, ddat(:, i)
!    enddo
!
!    write(22,*) 'bounds'
!    write(22,*) size(bornes, 1)
!    write(22,*) size(bornes, 2)
!    write(22,*) size(bornes, 3)
!
!    do i = 1, size(bornes, 1)
!      do j = 1, size(bornes, 2)
!        write(22,*) i,j, bornes(i,j, :)
!      enddo
!    enddo
!
!    close(22)
...
!  write(snumproc, "(I2)") numproc
!  open(file="bug0_"//trim(adjustl(snumproc)), unit = 22)
  !partie echanges
  if (nbproc>1) then
     !** cas >1 proc
...
!     write(22,*) 'sigma = ', sigma
     ...
     call MPI_BARRIER(MPI_COMM_WORLD,ierr)
!     write(22,*) 'nb_clusters_opt = ', nbideal
...
!           write(22, *) numproc,' : computing interface sigma interface :',sigma
