...
nbclusters(1) = importdata('sc5x4/nbclusters');
nbclusters(2) = importdata('ms1/nbclusters');
nbclusters(3) = importdata('ms2x2/nbclusters');
nbclusters
...
if p==2
   ...
   nbcluster = importdata('sc5x4/nbclusters')
   subplot(1,3,1)
   ...
   nbgrosclusters = 0;
   for i=1:nbcluster
       ii=importdata(strcat('sc5x4/cluster.final.',num2str(i)));
